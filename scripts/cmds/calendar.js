...
module.exports = {
  ...
  onStart: async function ({ api, event }) {
    try {
      ...
      const height = Math.max(600, startY + rowsNeeded * cellH + 80);
      ...
      weekdays.forEach((wd,i)=>{  
        ctx.fillText(emoji[i]?emoji[i]+' '+wd:wd, startX+i*cellW+10, startY+25);  
      });  
      ctx.shadowBlur=0;  
      ...
      days.forEach(day => {  
        ...
        ctx.fillRect(x, y, cellW-10, cellH-10);  
