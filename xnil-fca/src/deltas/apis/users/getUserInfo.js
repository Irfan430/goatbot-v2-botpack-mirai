                    ...
                    if (usePayload) {
                        ...
                        defaultFuncs.post("https://www.facebook.com/chat/user_info/", ctx.jar, form)
                            ...
                            .then(resData => {
                                    ...
                                    for (const prop in profiles) {
                                        if (profiles.hasOwnProperty(prop)) {
                                            ...
                                            retObj[prop] = {
                                                ...
                                                profilePicUrl: inner.thumbSrc || `https://graph.facebook.com/${prop}/picture?width=720&height=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`,
                                                profileUrl: inner.uri || `https://www.facebook.com/profile.php?id=${prop}`,
                                                gender: inner.gender === 1 ? "male" : inner.gender === 2 ? "female" : "no specific gender",
                                                type: inner.type || "user",
                                                isFriend: inner.is_friend || false,
                                                isBirthday: !!inner.is_birthday,
                                                searchTokens: inner.searchTokens || (inner.name ? inner.name.split(' ') : []),
                                                alternateName: inner.alternateName || null
                                            };
                                        }
                                    }
                                } else {
                                ...
                                return originalIdIsArray ? callback(null, retObj) : callback(null, retObj[ids[0]]);
                            })
                            .catch(err => {
