...
(async () => {
	const { data: lastCommit } = await axios.get('https://api.github.com/repos/xnil6x404/Goatbot-v2-botpack-mirai/commits/main');
	...
	const { data: versions } = await axios.get('https://raw.githubusercontent.com/xnil6x404/Goatbot-v2-botpack-mirai/refs/heads/main/versions.json');
	...
	for (const filePath in files) {
		...
		let getFile;
		try {
			const response = await axios.get(`https://github.com/xnil6x404/Goatbot-v2-botpack-mirai/raw/main/${filePath}`, {
	...
	const { data: packageHTML } = await axios.get("https://github.com/xnil6x404/Goatbot-v2-botpack-mirai/blob/main/package.json");
